        ...
        <div className="scoreboard__row">
          <div className="scoreboard__light__container">
            <div
              className={`scoreboard__light scoreboard__light--make ${
                score[1].make
                  ? "scoreboard__light--green"
                  :(score[1].make === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--model ${
                score[1].model
                  ? "scoreboard__light--green"
                  :(score[1].model === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--year ${
                score[1].year
                  ? "scoreboard__light--green"
                  :(score[1].year === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
        </div>
        <div className="scoreboard__row">
          <div className="scoreboard__light__container">
            <div
              className={`scoreboard__light scoreboard__light--make ${
                score[2].make
                  ? "scoreboard__light--green"
                  :(score[2].make === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--model ${
                score[2].model
                  ? "scoreboard__light--green"
                  :(score[2].model === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--year ${
                score[2].year
                  ? "scoreboard__light--green"
                  :(score[2].year === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
        </div>
        <div className="scoreboard__row">
          <div className="scoreboard__light__container">
            <div
              className={`scoreboard__light scoreboard__light--make ${
                score[3].make
                  ? "scoreboard__light--green"
                  :(score[3].make === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--model ${
                score[3].model
                  ? "scoreboard__light--green"
                  :(score[3].model === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--year ${
                score[3].year
                  ? "scoreboard__light--green"
                  :(score[3].year === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
        </div>
        <div className="scoreboard__row">
          <div className="scoreboard__light__container">
            <div
              className={`scoreboard__light scoreboard__light--make ${
                score[4].make
                  ? "scoreboard__light--green"
                  :(score[4].make === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--model ${
                score[4].model
                  ? "scoreboard__light--green"
                  :(score[4].model === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--year ${
                score[4].year
                  ? "scoreboard__light--green"
                  :(score[4].year === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
        </div>
        <div className="scoreboard__row">
          <div className="scoreboard__light__container">
            <div
              className={`scoreboard__light scoreboard__light--make ${
                score[5].make
                  ? "scoreboard__light--green"
                  :(score[5].make === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--model ${
                score[5].model
                  ? "scoreboard__light--green"
                  :(score[5].model === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
          <div className="scoreboard__light__container">
          <div
              className={`scoreboard__light scoreboard__light--year ${
                score[5].year
                  ? "scoreboard__light--green"
                  :(score[5].year === null? "" : "scoreboard__light--red")
              }`}
            />
          </div>
        </div>
